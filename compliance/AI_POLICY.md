# Automated-content and future AI policy

Version: 26 August 2026

## Current version

There is no external AI or LLM. The “Parent guide” is deterministic JavaScript running on the device from fixed astrology rules. The UI permanently discloses that it is automated, is not a person/external AI, may be wrong and does not diagnose.

Input is classified locally before storage. Medical/mental-health symptoms and diagnosis/treatment prompts, crisis/violence and restricted inference topics are not stored. Output comes from controlled templates and cannot call tools or a model.

## Prohibited outputs and uses
