(function () {
  ...
  const EXPORT_KEYS = [
    ...
    'parentScentCodeV2','child_astrology_local_analytics_v1','language'
  ];
  const APP_KEYS = [
    ...EXPORT_KEYS,
    PARENT_KEY,
  ...
  function validBackupValue(key,value){
    ...
    if(key==='parentScentCodeV2')return Boolean(value)&&typeof value==='object'&&!Array.isArray(value);
