(function () {
  const COPY = {
    ru: {
      ...
      reviewTitle: 'Проверьте данные', reviewHelp: 'После сохранения эти данные появятся в профиле ребёнка.', safetyNotice: 'Астрологические материалы предназначены для саморефлексии и родительского наблюдения. Они не являются медицинской, психологической, логопедической или другой профессиональной диагностикой. Не откладывайте консультацию квалифицированного специалиста из-за информации приложения.', name: 'Имя', date: 'Дата рождения', time: 'Время рождения', place: 'Место рождения', unknown: 'Неизвестно', done: 'Профиль ребёнка сохранён! ✨'
    },
    ua: {
      ...
      reviewTitle: 'Перевірте дані', reviewHelp: 'Після збереження ці дані з’являться у профілі дитини.', safetyNotice: 'Астрологічні матеріали призначені для саморефлексії та батьківського спостереження. Вони не є медичною, психологічною, логопедичною чи іншою професійною діагностикою. Не відкладайте консультацію кваліфікованого фахівця через інформацію застосунку.', name: "Ім’я", date: 'Дата народження', time: 'Час народження', place: 'Місце народження', unknown: 'Невідомо', done: 'Профіль дитини збережено! ✨'
    },
    en: {
      ...
      reviewTitle: 'Review the details', reviewHelp: "After saving, these details will appear in the child's profile.", safetyNotice: 'Astrological materials are for self-reflection and parental observation. They are not medical, psychological, speech-language or other professional diagnosis. Do not delay qualified professional care because of app information.', name: 'Name', date: 'Birth date', time: 'Birth time', place: 'Birth place', unknown: 'Unknown', done: 'Child profile saved! ✨'
    },
    nl: {
      ...
      reviewTitle: 'Controleer de gegevens', reviewHelp: 'Na het opslaan verschijnen deze gegevens in het profiel van het kind.', safetyNotice: 'Astrologische materialen zijn bedoeld voor zelfreflectie en observatie door ouders. Ze zijn geen medische, psychologische, logopedische of andere professionele diagnose. Stel professionele zorg niet uit vanwege informatie uit de app.', name: 'Naam', date: 'Geboortedatum', time: 'Geboortetijd', place: 'Geboorteplaats', unknown: 'Onbekend', done: 'Profiel van het kind opgeslagen! ✨'
    }
  };
