(function () {
  ...
  const SAFETY = {
    ru:{development:'Я не сохраняю этот вопрос и не связываю особенности развития или речи с натальной картой. Обсудите наблюдаемые навыки с педиатром, huisarts/consultatiebureau или логопедом; при речевых трудностях специалист может рекомендовать проверку слуха.',medical:'Я не сохраняю этот вопрос и не буду объяснять состояние ребёнка астрологией. Для симптомов, диагноза, лечения или психического состояния обратитесь к педиатру или профильному специалисту.',restricted:'Я не сохраняю этот вопрос. Астрология не используется для выводов о религии, сексуальности, интеллекте, опасности человека, смерти или для важных учебных, юридических и финансовых решений.',crisis:'Я не сохраняю этот вопрос. Если ребёнок может причинить вред себе или другому человеку либо есть непосредственная опасность, немедленно обратитесь в экстренную службу 112 и оставайтесь рядом с ребёнком.'},
    ua:{development:'Я не зберігаю це запитання й не пов’язую особливості розвитку або мовлення з натальною картою. Обговоріть навички, які спостерігаєте, з педіатром, huisarts/consultatiebureau чи логопедом; за мовленнєвих труднощів фахівець може порадити перевірку слуху.',medical:'Я не зберігаю це запитання й не пояснюватиму стан дитини астрологією. Щодо симптомів, діагнозу, лікування або психічного стану зверніться до педіатра чи профільного фахівця.',restricted:'Я не зберігаю це запитання. Астрологія не використовується для висновків про релігію, сексуальність, інтелект, небезпечність, смерть або для важливих освітніх, юридичних чи фінансових рішень.',crisis:'Я не зберігаю це запитання. Якщо дитина може завдати шкоди собі або іншій людині чи є безпосередня небезпека, негайно телефонуйте 112 і залишайтеся поруч із дитиною.'},
    en:{development:'I will not save this question or connect speech or developmental concerns to a birth chart. Discuss the skills you observe with a paediatrician, family doctor, child-health service or speech-language professional; a hearing check may also be recommended.',medical:'I will not save this question or explain a child’s condition through astrology. For symptoms, diagnosis, treatment or mental health, contact a paediatrician or qualified professional.',restricted:'I will not save this question. Astrology is not used to infer religion, sexuality, intelligence, dangerousness or death, or to make significant education, legal or financial decisions.',crisis:'I will not save this question. If the child may harm themselves or someone else, or there is immediate danger, call emergency services (112 in the EU) now and stay with the child.'},
    nl:{development:'Ik bewaar deze vraag niet en koppel zorgen over spraak of ontwikkeling niet aan een geboortehoroscoop. Bespreek de vaardigheden die u ziet met de huisarts, kinderarts, het consultatiebureau of een logopedist; een gehoorcontrole kan ook worden geadviseerd.',medical:'Ik bewaar deze vraag niet en leg de toestand van een kind niet uit via astrologie. Neem voor symptomen, diagnose, behandeling of psychische gezondheid contact op met een kinderarts of bevoegde professional.',restricted:'Ik bewaar deze vraag niet. Astrologie wordt niet gebruikt voor conclusies over religie, seksualiteit, intelligentie, gevaarlijkheid of overlijden, of voor belangrijke onderwijs-, juridische of financiële beslissingen.',crisis:'Ik bewaar deze vraag niet. Kan het kind zichzelf of iemand anders iets aandoen, of is er direct gevaar? Bel dan onmiddellijk 112 en blijf bij het kind.'}
  };
  const SAFETY_SOURCE_UI = {
    ru:{title:'Проверенные источники и следующий шаг',checked:'Проверено 27 августа 2026',government:'Rijksoverheid: куда обратиться по вопросам развития ребёнка',hearing:'Thuisarts: если есть сомнения по поводу слуха',health:'Thuisarts: медицинская информация от врачей'},
    ua:{title:'Перевірені джерела й наступний крок',checked:'Перевірено 27 серпня 2026',government:'Rijksoverheid: куди звернутися з питаннями розвитку дитини',hearing:'Thuisarts: якщо є сумніви щодо слуху',health:'Thuisarts: медична інформація від лікарів'},
    en:{title:'Verified sources and next step',checked:'Verified 27 August 2026',government:'Rijksoverheid: where to ask about child development',hearing:'Thuisarts: when you are concerned about hearing',health:'Thuisarts: doctor-reviewed health information'},
    nl:{title:'Gecontroleerde bronnen en volgende stap',checked:'Gecontroleerd op 27 augustus 2026',government:'Rijksoverheid: waar u terechtkunt met vragen over ontwikkeling',hearing:'Thuisarts: als u denkt dat uw kind slecht hoort',health:'Thuisarts: door artsen gecontroleerde medische informatie'}
  };
  ...
  function showSafety(kind) {
    ...
    box.insertAdjacentHTML('beforeend', `<div class="consultant-message assistant consultant-safety">${esc(SAFETY[lang()][kind])}${sources}</div>`);
