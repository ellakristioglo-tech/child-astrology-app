(function(){
  'use strict';
  const STORE='parentScentCodeV2';
  const LEGACY_STORE='familyScentCodeV1';
  const RETENTION_MS=90*24*60*60*1000;
  const SIGNS={ru:['Овен','Телец','Близнецы','Рак','Лев','Дева','Весы','Скорпион','Стрелец','Козерог','Водолей','Рыбы'],ua:['Овен','Телець','Близнюки','Рак','Лев','Діва','Терези','Скорпіон','Стрілець','Козоріг','Водолій','Риби'],en:['Aries','Taurus','Gemini','Cancer','Leo','Virgo','Libra','Scorpio','Sagittarius','Capricorn','Aquarius','Pisces'],nl:['Ram','Stier','Tweelingen','Kreeft','Leeuw','Maagd','Weegschaal','Schorpioen','Boogschutter','Steenbok','Waterman','Vissen']};
  const ELEMENT=['fire','earth','air','water','fire','earth','air','water','fire','earth','air','water'];
  const COPY={
    ru:{subtitle:'Персональный аромат только для совершеннолетних родителей и партнёров. Данные детей здесь не используются.',choose:'Выберите формат',modes:{my:['MY SCENT','Аромат одного взрослого родителя'],parents:['PARENTS SCENT','Общий аромат двух взрослых']},adultConfirm:'Я подтверждаю, что мне исполнилось 18 лет и я ввожу данные только совершеннолетних людей.',adultPrompt:'Подтвердите 18+, чтобы открыть форму. Профили и данные детей в расчёте свечи не используются.',adultRequired:'Сначала подтвердите, что вам исполнилось 18 лет.',details:'Данные рождения взрослых',help:'Мы программно рассчитываем положения планет. AI не придумывает карту.',roles:{self:'Я / родитель',partner:'Второй родитель / партнёр'},name:'Имя',date:'Дата рождения',time:'Точное время',place:'Место рождения',unknown:'Время неизвестно',cityHint:'Введите минимум 3 буквы и выберите город',cityLoading:'Ищем города…',cityNone:'Город не найден',cityError:'Поиск города временно недоступен',calculate:'СОЗДАТЬ АРОМАТ',working:'Рассчитываем карты и общий аккорд…',required:'Заполните имя, дату, время и выберите город для каждого взрослого.',adultDate:'Все участники должны быть старше 18 лет.',result:'YOUR PARENT SCENT',top:'Верхние ноты',heart:'Сердце',base:'База',story:'История вашего аромата',basis:'Почему именно эти ноты',composition:'Состав кода аромата',metrics:['Связь Луны','Гармония Венеры','Идентичность Солнца','Баланс стихий','Натальная подпись'],facts:'Основа расчёта',house:'дом',orderTitle:'Создать персональную свечу',orderText:'Элла получит название, состав и код аромата. Детальные данные рождения в сообщение не добавляются.',aboutLabel:'Расскажите немного о себе и заказе',aboutPlaceholder:'Для кого создаётся свеча, повод, любимые и нежелательные ноты, чувствительность к ароматам, страна доставки…',aboutHint:'Необязательно. Этот текст будет добавлен только в сообщение Элле.',messageTitle:'Заказ Parent Scent Code',scentLabel:'Аромат',extraLabel:'О заказчике и пожелания',whatsapp:'Заказать в WhatsApp',email:'Заказать по email',safety:'Только для взрослых. Рецептура свечи должна быть разработана из предназначенных для свечей fragrance oils с соблюдением актуальных ограничений IFRA. Аромат создаёт атмосферу и не является лечебным средством.',unknownFact:'время неизвестно — Асцендент и дома не использованы',asc:'Асцендент',savedLocal:'Расчёт сохранён на этом устройстве на 90 дней.',noAstro:'Не удалось рассчитать карту. Проверьте данные рождения и выбранный город.',members:'Взрослые участники'},
    ua:{subtitle:'Персональний аромат лише для повнолітніх батьків і партнерів. Дані дітей тут не використовуються.',choose:'Оберіть формат',modes:{my:['MY SCENT','Аромат одного дорослого з батьків'],parents:['PARENTS SCENT','Спільний аромат двох дорослих']},adultConfirm:'Я підтверджую, що мені виповнилося 18 років і я вводжу дані лише повнолітніх людей.',adultPrompt:'Підтвердьте 18+, щоб відкрити форму. Профілі та дані дітей у розрахунку свічки не використовуються.',adultRequired:'Спочатку підтвердьте, що вам виповнилося 18 років.',details:'Дані народження дорослих',help:'Ми програмно розраховуємо положення планет. AI не вигадує карту.',roles:{self:'Я / один із батьків',partner:'Другий із батьків / партнер'},name:'Ім’я',date:'Дата народження',time:'Точний час',place:'Місце народження',unknown:'Час невідомий',cityHint:'Введіть щонайменше 3 літери й оберіть місто',cityLoading:'Шукаємо міста…',cityNone:'Місто не знайдено',cityError:'Пошук міста тимчасово недоступний',calculate:'СТВОРИТИ АРОМАТ',working:'Розраховуємо карти та спільний акорд…',required:'Заповніть ім’я, дату, час і оберіть місто для кожного дорослого.',adultDate:'Усі учасники мають бути старші 18 років.',result:'YOUR PARENT SCENT',top:'Верхні ноти',heart:'Серце',base:'База',story:'Історія вашого аромату',basis:'Чому саме ці ноти',composition:'Склад коду аромату',metrics:['Зв’язок Місяця','Гармонія Венери','Ідентичність Сонця','Баланс стихій','Натальний підпис'],facts:'Основа розрахунку',house:'дім',orderTitle:'Створити персональну свічку',orderText:'Елла отримає назву, склад і код аромату. Детальні дані народження у повідомлення не додаються.',aboutLabel:'Розкажіть трохи про себе та замовлення',aboutPlaceholder:'Для кого створюється свічка, нагода, улюблені й небажані ноти, чутливість до ароматів, країна доставки…',aboutHint:'Необов’язково. Цей текст буде додано лише до повідомлення Еллі.',messageTitle:'Замовлення Parent Scent Code',scentLabel:'Аромат',extraLabel:'Про замовника та побажання',whatsapp:'Замовити у WhatsApp',email:'Замовити через email',safety:'Лише для дорослих. Рецептуру свічки слід розробляти з fragrance oils для свічок із дотриманням актуальних обмежень IFRA. Аромат створює атмосферу й не є лікувальним засобом.',unknownFact:'час невідомий — Асцендент і будинки не використані',asc:'Асцендент',savedLocal:'Розрахунок збережено на цьому пристрої на 90 днів.',noAstro:'Не вдалося розрахувати карту. Перевірте дані й обране місто.',members:'Дорослі учасники'},
  ...
  const REASON={
    ...
    en:{fire:'brings warmth, vitality and forward movement',earth:'gives stability, physical comfort and a dependable foundation',air:'reflects clear communication, lightness and space',water:'expresses emotional depth, care and gentle closeness',balance:'acts as a balancing note, joining contrasts without labelling them as negative'},
    nl:{fire:'brengt warmte, levendigheid en beweging',earth:'geeft stabiliteit, lichamelijk comfort en een betrouwbare basis',air:'weerspiegelt heldere communicatie, lichtheid en ruimte',water:'verbeeldt emotionele diepte, zorg en zachte nabijheid',balance:'werkt als balancing note en verbindt contrasten zonder ze negatief te noemen'}
  };
  const state={mode:'parents',ageConfirmed:false,people:[],places:{},result:null,searchTimers:{},controllers:{}};
  const rolesFor={my:['self'],parents:['self','partner']};
  function lang(){const stored=localStorage.getItem('language'),html=(document.documentElement.lang||'').toLowerCase(),fromHtml=html==='uk'?'ua':html.slice(0,2);if(COPY[stored])return stored;if(typeof currentLanguage!=='undefined'&&COPY[currentLanguage])return currentLanguage;if(COPY[fromHtml])return fromHtml;return'nl';}
  function c(){return COPY[lang()];}
  const SCENT_NAMES={
    ru:{'Golden Roots':'Золотые корни','Luminous Air':'Сияющий воздух','Amber Tide':'Янтарный прилив','Silver Garden':'Серебряный сад','Velvet Roots':'Бархатные корни','Quiet Horizon':'Тихий горизонт','Solar Ember':'Солнечный жар','Deep Garden':'Глубокий сад','Clear Orbit':'Ясная орбита','Moonlit Tide':'Лунный прилив'},
    ua:{'Golden Roots':'Золоті корені','Luminous Air':'Сяюче повітря','Amber Tide':'Бурштиновий приплив','Silver Garden':'Срібний сад','Velvet Roots':'Оксамитові корені','Quiet Horizon':'Тихий обрій','Solar Ember':'Сонячне тепло','Deep Garden':'Глибокий сад','Clear Orbit':'Ясна орбіта','Moonlit Tide':'Місячний приплив'},
    en:{},
  ...
  const ORDER_COPY={
    ...
    ua:{result:'АРОМАТ ДЛЯ БАТЬКІВ',title:'Замовлення Parent Scent Code',candle:'Свічка',forWhom:'Аромат створено для',name:'Ваше ім’я',namePlaceholder:'Як до вас звертатися',contact:'Телефон або email',contactPlaceholder:'+31… або name@email.com',customer:'Замовник',contactLine:'Контакт',hint:'Ці дані буде додано до повідомлення Еллі.'},
    en:{result:'PARENT SCENT',title:'Parent Scent Code order',candle:'Candle',forWhom:'Scent created for',name:'Your name',namePlaceholder:'How should we address you?',contact:'Phone or email',contactPlaceholder:'+31… or name@email.com',customer:'Customer',contactLine:'Contact',hint:'These details will be added to your message to Ella.'},
    nl:{result:'GEUR VOOR OUDERS',title:'Bestelling Parent Scent Code',candle:'Kaars',forWhom:'Geur samengesteld voor',name:'Uw naam',namePlaceholder:'Hoe mogen we u aanspreken?',contact:'Telefoon of e-mail',contactPlaceholder:'+31… of name@email.com',customer:'Klant',contactLine:'Contact',hint:'Deze gegevens worden toegevoegd aan uw bericht aan Ella.'}
  };
  function noteName(key){return NOTE_NAMES[lang()]?.[key]||NOTE[key].name}
  function scentName(name){return SCENT_NAMES[lang()]?.[name]||name}
  function oc(){const copy=ORDER_COPY[lang()],code=document.querySelector('.scent-code');if(code)code.textContent=copy.result;return copy}
  function esc(v){return String(v??'').replace(/[&<>'"]/g,x=>({'&':'&amp;','<':'&lt;','>':'&gt;',"'":'&#39;','"':'&quot;'}[x]));}
  function adultDateMax(){const d=new Date();d.setFullYear(d.getFullYear()-18);return new Date(d-d.getTimezoneOffset()*60000).toISOString().slice(0,10);}
  function freshPerson(role,index){return {key:`${role}-${index}`,role,name:'',birthDate:'',birthTime:'',unknown:false,place:null,placeQuery:''};}
  function ensurePeople(){const roles=rolesFor[state.mode];const old=state.people;state.people=roles.map((role,i)=>old.find(p=>p.role===role)||freshPerson(role,i));}
  function icon(role){return role==='partner'?'♡':'✦';}
  function modeMarkup(){return Object.entries(c().modes).map(([key,val])=>`<button class="scent-mode ${state.mode===key?'active':''}" type="button" data-scent-mode="${key}"><span class="scent-mode-icon">${key==='my'?'✦':'♡'}</span><strong>${val[0]}</strong><small>${val[1]}</small></button>`).join('')}
  function personMarkup(p,index){return `<div class="scent-person" data-person="${index}"><div class="scent-person-head"><div class="scent-person-title"><span class="scent-role-badge">${icon(p.role)}</span>${c().roles[p.role]}</div></div><div class="scent-fields"><div class="scent-field"><label>${c().name}</label><input data-field="name" value="${esc(p.name)}" autocomplete="name"></div><div class="scent-field"><label>${c().date}</label><input data-field="birthDate" type="date" max="${adultDateMax()}" value="${esc(p.birthDate)}"></div><div class="scent-field"><label>${c().time}</label><div class="scent-time-row"><input data-field="birthTime" type="time" value="${esc(p.birthTime)}" ${p.unknown?'disabled':''}><label class="scent-unknown"><input data-field="unknown" type="checkbox" ${p.unknown?'checked':''}> ${c().unknown}</label></div></div><div class="scent-field scent-place"><label>${c().place}</label><input data-field="placeQuery" type="search" autocomplete="off" value="${esc(p.placeQuery)}"><div class="scent-city-status" data-city-status>${p.place?`✓ ${esc(p.place.label)}`:c().cityHint}</div><div class="scent-city-results" data-city-results></div></div></div></div>`}
  function render(){ensurePeople();const root=document.getElementById('familyScentApp');if(!root)return;const form=state.ageConfirmed?`<div class="scent-form-card"><div class="scent-form-head"><div><h3>${c().details}</h3><p>${c().help}</p></div></div><div class="scent-members">${state.people.map(personMarkup).join('')}</div><div class="scent-actions"><button class="scent-calculate" type="button">${c().calculate}</button><div class="scent-form-error" role="alert"></div><span class="scent-save-note">${c().savedLocal}</span></div></div>`:`<div class="scent-adult-note">${c().adultPrompt}</div>`;root.innerHTML=`<div class="family-scent-shell"><div class="scent-hero"><div class="scent-kicker">CHILD ASTROLOGY · Ella Kristioglo</div><h2>PARENT SCENT CODE · 18+</h2><p>${c().subtitle}</p><div class="scent-mode-grid" aria-label="${c().choose}">${modeMarkup()}</div><label class="scent-adult-gate"><input id="scentAdultConfirm" type="checkbox" ${state.ageConfirmed?'checked':''}><span>${c().adultConfirm}</span></label></div>${form}<div id="familyScentResult">${state.ageConfirmed&&state.result?resultMarkup(state.result):''}</div></div>`;bind();}
  function bind(){document.querySelectorAll('[data-scent-mode]').forEach(b=>b.addEventListener('click',()=>{state.mode=b.dataset.scentMode;state.people=[];state.result=null;render()}));document.getElementById('scentAdultConfirm')?.addEventListener('change',e=>{state.ageConfirmed=e.target.checked;if(!state.ageConfirmed)state.result=null;render()});document.querySelectorAll('[data-person]').forEach(card=>{const i=Number(card.dataset.person),p=state.people[i];card.querySelectorAll('[data-field]').forEach(input=>input.addEventListener('input',()=>{const f=input.dataset.field;if(f==='unknown'){p.unknown=input.checked;p.birthTime=p.unknown?'':p.birthTime;card.querySelector('[data-field="birthTime"]').disabled=p.unknown}else{p[f]=input.value;if(f==='placeQuery'&&p.place&&input.value!==p.place.label)p.place=null;if(f==='placeQuery')scheduleCity(i,input.value,card)}}));});document.querySelector('.scent-calculate')?.addEventListener('click',calculate);bindOrderActions()}
